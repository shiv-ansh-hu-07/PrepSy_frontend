    ...
    >
      <span
        style={{
          ...
          borderTopColor: "#5f6fa3",
          animation: "loading-screen-spin 0.8s linear infinite",
        }}
      />

      {elapsedTier === "fast" && (
        <p style={{ color: "#5f6fa3", fontSize: "15px", margin: 0 }}>Loading...</p>
      )}

      {elapsedTier === "slow" && (
        <p style={{ color: "#5f6fa3", fontSize: "15px", margin: 0, maxWidth: "320px" }}>
      ...
      {elapsedTier === "verySlow" && (
        <p style={{ color: "#5f6fa3", fontSize: "15px", margin: 0, maxWidth: "340px" }}>

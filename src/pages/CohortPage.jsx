        ...
        <main style={{ minWidth: 0 }}>
          ...
          {activeTab === "sessions" && (
            <div style={card}>
              ...
              {cohort.isMember && sessions.length > 0 && (
                <p style={{ margin: "0 0 16px", fontSize: 12, color: "var(--text-muted)" }}>
                  ✨ Your schedule adapts automatically — when the cohort watches ahead, finished videos drop out and the remaining days re-pack so you finish sooner.
                </p>
              )}
